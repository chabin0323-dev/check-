export default function Home() {
  return (
    <div style={{ backgroundColor: '#0f021b', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'sans-serif', padding: '20px' }}>
      <div style={{ maxWidth: '420px', width: '100%', border: '1px solid rgba(180, 100, 255, 0.4)', borderRadius: '20px', padding: '32px 24px', background: 'rgba(255,255,255,0.04)' }}>
        ...
        <a href=href="https://www.paypal.com/ncp/payment/AMEJ4V5C564UN" target="_blank" rel="noreferrer" style={{ display: 'block', textAlign: 'center' }}>
